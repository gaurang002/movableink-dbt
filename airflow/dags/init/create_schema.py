...
with DAG(
    ...
    create_schema = SQLExecuteQueryOperator(
        ...
        sql="select count(*) from airflow_test;",
    ...
    '''
    print_home = PythonOperator(
        task_id='print_airflow_home',
        python_callable=print_airflow_home,
    )
    '''
    ...
    create_bronze_tables = PostgresOperator(
        ...
        postgres_conn_id='my_postgres_conn',
        sql="sql/create_bronze_tables.sql",
    )

#print_home
create_schema >> create_bronze_tables